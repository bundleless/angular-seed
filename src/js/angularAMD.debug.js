/*!
 ...
 License: MIT
 https://unpkg.com/browse/angular-amd@0.2.1/angularAMD.js
*/
define(function () {
  'use strict';
      ...
      */
      ...
      if (load_controller) {
          ...
          resolve['__AAMDCtrl'] = ['$q', '$rootScope', function ($q, $rootScope) { // jshint ignore:line
              var defer = $q.defer();
              // console.info({require}, 'loading:', load_controller)
              // System.import(load_controller).then(function (ctrl) {
              require([load_controller], function (ctrl) {
                  // console.info('loaded:', ctrl)
                  defer.resolve(ctrl);
                  $rootScope.$apply();
              });
